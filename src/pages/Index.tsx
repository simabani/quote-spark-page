...
const Index = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 bg-gradient-to-br from-lavender via-background to-baby-blue font-quicksand">
      ...
      <div className="w-full max-w-4xl mx-auto text-center relative z-10">
        ...
        <footer className="mt-12 text-muted-foreground/60 text-sm animate-fade-in">
